...
export const HELP_RECIPES: HelpRecipe[] = [
  ...
  },
  {
    ...
    summary:
      "Accumulate (y, x) pairs with Σ+, then forecast with g × (ŷ) or g − (x̂).",
    steps: [
      "Optional: f SST to clear statistics.",
      "Enter y, press ENTER, enter x, press Σ+ — repeat for each pair.",
      "After Σ+, the display shows n (pair count), not your last x — key a new x before forecasting.",
      "Forecast ŷ: enter x, press g × (multiply key) — result in X; r in Y.",
      "Forecast x̂: enter y, press g − (subtract key) — result in X.",
      "After g ×, press x↔y to view correlation r in X.",
      "Example — (1, 2), (2, 4), (3, 7): clear with f SST, then 2 ENTER 1 Σ+, 4 ENTER 2 Σ+, 7 ENTER 3 Σ+.",
      "Intercept: 0 g × → −0.67. Slope check: 1 g × → 1.83 (1.83 − (−0.67) = 2.5).",
      "Predict y at x = 4: 4 g × → 9.33, then x↔y → r ≈ 0.99.",
    ],
  },
  {
    id: "statistics",
